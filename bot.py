    ...
    async def create_prompt_action(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            prompt = (
                ...
                "КЛЮЧЕВОЕ ТРЕБОВАНИЕ: агент должен реализовать проект БЕЗ дополнительных вопросов к пользователю.\n\n"
                "ШАБЛОН ПРОМПТА:\n\n"
                ...
                "- БЕЗ фраз 'оцените', 'проанализируйте' и подобных\n"
                ...
                f"--- АНАЛИЗ ---\n{analysis}\n\n"
                "Теперь создай самодостаточный промпт по шаблону выше."
            )
